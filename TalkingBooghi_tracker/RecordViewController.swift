...
struct Intervention: Codable {
    ...
    var weekofyear: String
    var month: String
    init(carddata: [String], cardname: String, cardtype: String, created: String, creator: String, description: String, isGood: Bool, status: String, type: String, interventiontype: String, date: String, weekofyear: String, month: String) {
        self.carddata = carddata
        self.cardname = cardname
        self.cardtype = cardtype
